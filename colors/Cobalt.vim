...
hi Comment	    guifg=#148aff    ctermfg=234    gui=bold    cterm=bold 
hi Constant	    guifg=#00ff00    ctermfg=232    gui=none    cterm=none 
...
hi Identifier	    guifg=#cccccc    ctermfg=252    gui=none    cterm=none 
hi LineNr	    guifg=#878787    ctermfg=103    guibg=#e3e3e3    ctermbg=254    gui=none    cterm=none 
hi MatchParen	    guifg=#ccffcc    ctermfg=252    guibg=#008b8b    ctermbg=33    gui=none    cterm=none 
hi Normal	    guifg=#ffd930    ctermfg=225    guibg=#033051    ctermbg=51    gui=none    cterm=none 
...
hi Statement	    guifg=#fb9d0f    ctermfg=196    gui=none    cterm=none 
...
hi Type	    guifg=#ffe873    ctermfg=225    gui=none    cterm=none 
